/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b84f43f5c1036cec3c7ca3cfd9ecb58f)
...
declare namespace Cloudflare {
	interface Env {
		...
		ADMIN_CHAT: DurableObjectNamespace<import("./src/index").AdminChat>;
		PUBLIC_CHAT: DurableObjectNamespace<import("./src/index").PublicChat>;
