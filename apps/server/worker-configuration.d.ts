/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 3ed894a1fbad123d3ca9db250e76a629)
...
declare namespace Cloudflare {
	interface Env {
		...
		ADMIN_CHAT: DurableObjectNamespace /* AdminChat from ecomantem-server */;
		PUBLIC_CHAT: DurableObjectNamespace /* PublicChat from ecomantem-server */;
