...
__export(index_exports, {
  ...
  TODOS_QUERY_KEYS: () => TODOS_QUERY_KEYS,
  TodoStorage: () => TodoStorage,
  TodosApi: () => TodosApi,
  createBrowserTodosApi: () => createBrowserTodosApi,
  createOfflineTodo: () => createOfflineTodo,
  createTodoSchema: () => createTodoSchema,
  createTodosApi: () => createTodosApi,
  createTodosHooks: () => createTodosHooks,
  deleteTodoSchema: () => deleteTodoSchema,
  fileToBase64: () => fileToBase64,
  generateLocalId: () => generateLocalId,
  offlineTodoSchema: () => offlineTodoSchema,
  queuedActionSchema: () => queuedActionSchema,
  todoSchema: () => todoSchema,
  todoToOfflineTodo: () => todoToOfflineTodo,
...
var todoSchema = import_zod.z.object({
  id: import_zod.z.number(),
  text: import_zod.z.string(),
  completed: import_zod.z.boolean(),
  imageUrl: import_zod.z.string().nullable()
});
var createTodoSchema = import_zod.z.object({
  text: import_zod.z.string().min(1),
  imageUrl: import_zod.z.string().optional()
});
var updateTodoSchema = import_zod.z.object({
  id: import_zod.z.number(),
  completed: import_zod.z.boolean()
});
var deleteTodoSchema = import_zod.z.object({
  id: import_zod.z.number()
});
var uploadImageSchema = import_zod.z.object({
  todoId: import_zod.z.number(),
  filename: import_zod.z.string(),
  contentType: import_zod.z.string(),
  fileData: import_zod.z.string()
  // Base64 encoded file data
});
var offlineTodoSchema = todoSchema.extend({
  status: import_zod.z.enum(["synced", "pending", "syncing", "error"]),
  localId: import_zod.z.string(),
  serverId: import_zod.z.number().nullable(),
  createdAt: import_zod.z.number(),
  error: import_zod.z.string().optional()
});
var queuedActionSchema = import_zod.z.object({
  id: import_zod.z.string(),
  type: import_zod.z.enum(["create", "update", "delete"]),
  todo: offlineTodoSchema,
  timestamp: import_zod.z.number(),
  retryCount: import_zod.z.number().default(0)
});
